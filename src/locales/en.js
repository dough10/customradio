module.exports = {
  ...
  step1: 'Filter stations by name, genre or url (e.g., somafm, hip hop, jazz), then add all the stations you would like to include in your radio.txt file.',
  ...
  filterLabel: 'Filter by name, genre or url',
